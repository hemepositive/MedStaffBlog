---
title: 'Dragon Medical One: Toolbar Icon Removal'
slug: dragon-toolbar-removal
excerpt: Launching Dragon from the PowerChart toolbar sends dictation to the Dictation Box instead of your note. We are removing the toolbar icon — launch Dragon from the desktop PowerChart with Dragon icon or the 1Chart storefront instead.
date: 2026-06-01
...
## Critical Dragon toolbar launch issue impacting clinical documentation
...
**We will be removing the Dragon icon from the PowerChart and FirstNet toolbars** to prevent use of the unsupported launch method and reduce ongoing provider workflow disruption.

![Dragon icon in the PowerChart toolbar](/images/dragon-icon-changes/dragon-toolbar.png)

## Recommended launch methods

Please use the icons below to launch Dragon along with PowerChart or FirstNet:

![PowerChart with Dragon icon](/images/dragon-icon-changes/dragon-icon-pc.png)

![FirstNet with Dragon icon](/images/dragon-icon-changes/dragon-icon-fn.png)
