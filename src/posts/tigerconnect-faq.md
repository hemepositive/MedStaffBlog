...
TigerConnect is a secure clinical communication platform used at Huntsville Hospital for HIPAA-compliant messaging between healthcare providers, staff, and care teams.

### Why is the hospital implementing TigerConnect?

Modern hospitals use secure-messaging as part of their workflows as communication is essential to efficient and safe patient care. HIPAA-compliance ensures our providers can relay important patient information without worry about their communication security.

### How do I download TigerConnect?

TigerConnect is available for download from the Apple App Store (iOS) or Google Play Store (Android). You can also access it via desktop application or web browser. [TigerConnect: Messenger Webapp](https://login.tigerconnect.com)
...
Yes, TigerConnect is HIPAA-compliant and uses end-to-end encryption to protect patient information and clinical communications.

### Can I use TigerConnect for patient information?

Yes, TigerConnect is specifically designed for secure clinical communication and is approved for discussing patient information, unlike standard text messaging.

### How do I find a colleague on TigerConnect?

Use the search function to find colleagues by name or role. You can also browse the directory to locate specific departments or care teams.

### What if I'm not receiving notifications?

Check your device notification settings and ensure TigerConnect has permission to send notifications. Also verify your in-app notification preferences are configured correctly.

### How can I tell if I sent a message to someone who has not activated their account?
